    ...
    (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            if (inst.options.isAndroid) {
                 match = navigator.userAgent.match(/Android\s([0-9\.]*)/i);
            ...
            inst.createMarkup =
                function() {
                    ...
                    inst.$lightbox = $("<div id='html5box-html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999998;text-align:center;'>" + "<div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:100%;min-height:100%;background-color:" + inst.options.overlaybgcolor + ";opacity:" + inst.options.overlayopacity +
                        ";filter:alpha(opacity=" + Math.round(inst.options.overlayopacity * 100) + ");'></div>" + "<div id='html5-lightbox-box' style='display:block;position:relative;margin:0px auto;'>" + "<div class='html5-elem-box' style='display:block;position:relative;width:100%;height:" + elemheight + ";margin:0px auto;text-align:center;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;'>" + "<div class='html5-elem-wrap' style='display:block;position:relative;margin:0px auto;text-align:center;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;background-color:" +
                    ...
                    if (inst.options.fullscreenmode) {
                        ...
                        inst.$lightboxBox.append("<div id='html5-close' class='html5-close' style='display:none;cursor:pointer;position:absolute;top:0;right:0;margin-top:-16px;margin-right:-16px;'><img alt='' src='" +
            ...
            inst.finish = function() { 
				...
				//vid2.pause();
				//$(".html5-elem-box").find($(".player").get(0).pause());
				 // var vid1=new Plyr($('.player'));
				 // vid1.pause();
				 
				 
				// alert($(this).parent().html());
				 
			//	 var instance = $(".player").get(1).plyr;
